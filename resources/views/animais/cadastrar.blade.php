...
<div class="flex flex-wrap">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" method="post" action="{{route ('animais.gravar')}}" enctype="multipart/form-data">
            @csrf
            <div class="">
            ...
            <div class="mt-2">
                <label class="block text-sm text-gray-600" for="idade">Imagem</label>
