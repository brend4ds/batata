...
<head>
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            ...
            {{-- //opacity-75 hover:opacity-100(inativo)
            //active-nav-link (ativo) --}}
        </div>
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="{{ route ('animais')}}" class="flex items-center text-white py-4 pl-6 nav-item 
                @if(Request::is('animais*'))active-nav-link @else opacity-75 hover:opacity-100 @endif">
                <i class="fas fa-sticky-note mr-3"></i>
                Animais
            </a>
            @if(Auth::user() && Auth::user()['admin'])
            <a href="{{ route ('usuarios')}}" class="flex items-center text-white py-4 pl-6 nav-item
            @if(Request::is('usuarios*'))active-nav-link @else opacity-75 hover:opacity-100 @endif">
